...
public class Client {
    ...
    public void enter() {
        try (Scanner scanner = new Scanner(System.in);
            ...
            socketChannel.connect(new InetSocketAddress("localhost", 23444));
            final ByteBuffer byteBuffer = ByteBuffer.allocate(2 << 10);
            StringBuilder sb = new StringBuilder();
            while (true) {
                System.out.println("Введите каждое слово отдельно с пробелом или end для получения результата");
